...
<th width="30" align="center" class="h">显示</th>
<th width="auto" align="center" class="h">广告名</th>
<th width="auto" align="center" class="h">节点</th>
<th width="35" align="center" class="h">期限</th>
<th width="35" align="center" class="h" style="border-right: none;">操作</th>
</tr>

<?php
foreach($ads as $ad) {
echo '<tr><td width="20" align="center" class="d">', $ad['id'], '</td><td width="30" align="center" class="d">', $ad['sortid'], '</td><td width="30" align="center" class="d">'; if ($ad['invisible']==0){echo '<span class="negative">显</span>';}else{echo '<span class="positive">隐</span>';}echo '</td><td width="auto" align="left" class="d">', $ad['name'],'</td><td width="auto" align="left" class="d">', Html::a(Html::encode($ad['node']['name']), ['topic/node', 'name'=>$ad['node']['ename']]),'</td><td width="35" align="center" class="d">', $ad['expires'], '</td><td width="35" height="20" align="center" class="d" style="border-right: none;">', 
Html::a('编辑', ['edit', 'id'=>$ad['id']],['class' => 'super normal button']), '<br><br>', 

...
<div class="sep5"></div>
<div class="box">
<div class="header"><?php echo Html::a('管理后台', ['admin/setting/']), '<span class="chevron">&nbsp;›&nbsp;</span>', Html::a('插件管理', ['index']);?></div>
<div class="box">
<div class="cell"><?php echo Html::a('已安装插件', ['index'],['class'=>'super normal button']); ?></div>

...
<div class="box">
<div class="cell"><?php echo Html::a('添加新链接', ['add'],['class'=>'super normal button']); ?></div>
...
echo '<tr><td width="20" align="center" class="d">', $link['id'], '</td><td width="30" align="center" class="d">', $link['sortid'], '</td><td width="auto" align="left" class="d">', $link['name'], '&nbsp;(', Html::a($link['url'], $link['url']), ')&nbsp; &nbsp;</td><td width="35" height="20" align="center" class="d" style="border-right: none;">', 
Html::a('编辑', ['edit', 'id'=>$link['id']],['class' => 'super normal button']), '<br><br>', 

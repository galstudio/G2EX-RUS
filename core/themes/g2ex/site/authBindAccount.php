...
<tr>
<td width="120" align="right">还没本站帐号？<div class="sep20"></div></td>
<td width="auto" align="left">&nbsp;&nbsp;<?=Html::a('创建本站帐号并绑定', ['auth-signup'], ['class'=>'super normal button']); ?><div class="sep20"></div></td>
</tr>
<tr>
<td width="auto" align="left" colspan="2" style="padding: 10px 130px;font-size: 16px;border-top: #e2e2e2 1px solid;"><strong>绑定本站账号</strong></td>
</tr>
<tr>
...
<div class="sep5"></div>
<?=Html::submitButton('绑定', ['class' => 'super normal button', 'name' => 'login-button']);?>

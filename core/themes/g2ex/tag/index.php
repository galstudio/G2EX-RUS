...
$this->title = Html::encode($settings['site_name']) . ' › '.Html::encode($tag['name']);
?>
...
<div class="sep20"></div>
<div class="box">
<div class="header"><div class="fr f12"><span class="fade">共 <?= $tag['topic_count'] ?> 个主题</span></div><?=Html::a(Html::encode($settings['site_name']), ['/']); ?> <span class="chevron">&nbsp;›&nbsp;</span> <?=Html::encode($tag['name']); ?></div>

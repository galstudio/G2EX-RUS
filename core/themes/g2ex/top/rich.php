...
<?=Html::a('Остаток на счете', ['my/balance'],['class'=>'tab']); ?><?=Html::a('Пополнить баланс', ['my/add'],['class'=>'tab']); ?></div><?=Html::a(Html::encode($settings['site_name']), ['/']); ?> <span class="chevron">&nbsp;›&nbsp;</span> <?=$title ;?></div>
<?php
...
<span class="fade">пользователь №<?=Html::encode($user['id'])?></span>
</td>
...
<td colspan="3"><div style="height: 1px; background-color: #f0f0f0; border-bottom: 1px solid #fcfcfc;"></div></td>
 ...
 if( !$isGuest ) {?>
<tr>
<td colspan="3" align="center"><span class="fade">Вы <?php if ($myInfo->top_close >0) {echo 'в настоящее время не участвуете';}else{echo 'участвуете';}?> в рейтинге</span></td>
</tr>
 <?php };?>
</tbody></table>
</div>

...
<div class="sep20"></div>
<div class="box">
<div class="header"><?=Html::a(Html::encode($settings['site_name']), ['/']); ?> <span class="chevron">&nbsp;›&nbsp;</span> Пользователи которых я читаю<div class="fr f12"><span class="snow">Всего&nbsp;</span> <strong class="gray"><?=$pages->totalCount;?></strong></div></div>

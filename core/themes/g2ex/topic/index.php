...
$this->title = Html::encode($settings['site_name']) . ' › Новые топики  ' . $currentPage . '/'.$pages->pagecount;
}
else{
$this->title = Html::encode($settings['site_name']) . ' › Новые топики';
}
?>
...
<div class="sep20"></div>
<div class="box">
<div class="header"><div class="fr f12"><span class="fade"><?php echo Yii::t('app', '{n, plural, one{# топик} few{# топика} many{# топиков} other{# топика}}', ['n' => $siteinfo['topics']]);?></span></div><?php echo Html::a(Html::encode($settings['site_name']), ['/']); ?> <span class="chevron">&nbsp;›&nbsp;</span> Новые записи</div>

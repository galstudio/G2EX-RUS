...
<?php
echo Html::a('全部', ['topic/home'],['class'=>'tab']);
$navis = Navi::getHeadNaviNodes();
foreach($navis as $current) {
	echo Html::a(Html::encode($current['name']), ['topic/navi', 'name'=>$current['ename']], $current['id']==$navi['id']?['class'=>'tab_current']:['class'=>'tab']);
}if(!$isGuest){
...
<div class="inner">
        <span class="chevron">→</span> <?=Html::a('更多新主题', ['topic/recent']);?>
    </div>
</div>
</div>
<div class="sep20"></div>

...
class WysibbEditor extends Editor implements PluginInterface
{
    ...
    public static function info()
    {
        return [
            'id' => 'WysibbEditor',
            'name' => 'Редактор Wysibb (BBcode)',
            'description' => 'Редактор Wysibb (BBcode)',
            'author' => 'SimpleForum',
    ...
    public static function install()
    {
        if ( ($setting = Setting::findOne(['key'=>'editor'])) ) {
            ...
            $option['WysibbEditor']='Редактор Wysibb (BBcode)';
    ...
    public function registerAsset($view)
    {
        ...
        $view->registerJs("$('#editor').wysibb({lang:'ru', buttons: 'bold,italic,underline,strike,fontcolor,justifyleft,justifycenter,justifyright,bullist,numlist,img,link,code,quote'});");
    }

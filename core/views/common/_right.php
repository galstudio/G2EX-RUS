...
<ul class="list-group sf-box">
  <li class="list-group-item">
        ...
        <ul class="list-inline text-center favorite-list">
          <li><?php echo Html::a($myInfo->favorite_node_count.'<br /><span class="gray">Темы</span>', ['my/nodes']); ?></li>
          <li><?php echo Html::a($myInfo->favorite_topic_count.'<br /><span class="gray">Топики</span>', ['my/topics']); ?></li>
          <li><?php echo Html::a($myInfo->favorite_user_count.'<br /><span class="gray">Читаю</span>', ['my/following']); ?></li>
        </ul>
  </li>

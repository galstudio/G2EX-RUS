...
*/
    $follow = Favorite::checkFollow($me->id, Favorite::TYPE_NODE, $node['id'])?Html::a('<i class="fa fa-star fa-lg aria-hidden="true""></i><span class="favorite-num">' . ($node['favorite_count']>0?$node['favorite_count']:'') . '</span>', null, ['class'=>'favorite', 'title'=>'Из избранного', 'href' => 'javascript:void(0);', 'params'=>'unfavorite node '. $node['id']]):Html::a('<i class="fa fa-star-o fa-lg" aria-hidden="true"></i><span class="favorite-num">' . ($node['favorite_count']>0?$node['favorite_count']:'') . '</span>', null, ['class'=>'favorite', 'title'=>'В избранное', 'href' => 'javascript:void(0);', 'params'=>'favorite node '. $node['id']]);
    $follow = '  •  '.$follow;
} else {
    $follow = '';
}

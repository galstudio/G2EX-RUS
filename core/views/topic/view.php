...
if(!$isGuest && $me->isActive()) {
    ...
    $userOp['follow'] = Favorite::checkFollow($me->id, Favorite::TYPE_TOPIC, $topic['id'])?Html::a('<i class="fa fa-ml10 fa-star fa-lg aria-hidden="true""></i><span class="favorite-num">' . ($topic['favorite_count']>0?$topic['favorite_count']:'') . '</span>', null, ['class'=>'favorite', 'title'=>'Из избранного', 'href' => 'javascript:void(0);', 'params'=>'unfavorite topic '. $topic['id']]):Html::a('<i class="fa fa-ml10 fa-star-o fa-lg" aria-hidden="true"></i><span class="favorite-num">' . ($topic['favorite_count']>0?$topic['favorite_count']:'') . '</span>', null, ['class'=>'favorite', 'title'=>'В избранное', 'href' => 'javascript:void(0);', 'params'=>'favorite topic '. $topic['id']]);
} else {
    $userOp['good'] = '<i class="fa fa-thumbs-o-up fa-lg" aria-hidden="true"></i><span class="good-num">' . ($topic['good']>0?$topic['good']:'') . '</span>';

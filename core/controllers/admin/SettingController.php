...
class SettingController extends CommonController
{
    ...
    {
        $configs = [
            'type'=>['label'=>'Тип', 'key'=>'type', 'type'=>'select', 'value_type'=>'text', 'value'=>'', 'description'=>'', 'option'=>'{"":"", "qq":"QQ", "weibo":"Weibo", "weixin":"Weixin", "github":"Github"}'],
            'sortid'=>['label'=>'Порядок', 'key'=>'sortid', 'type'=>'text', 'value_type'=>'integer', 'value'=>'1', 'description'=>''],
            'show'=>['label'=>'Показывать', 'key'=>'show', 'type'=>'select', 'value_type'=>'integer', 'value'=>'0', 'description'=>'', 'option'=>'["0(на странице входа)", "1(в сайдбаре всех страниц)"]'],
            ...
            'title'=>['label'=>'Название', 'key'=>'title', 'type'=>'text', 'value_type'=>'text', 'value'=>'', 'description'=>'']
        ];
        $titles = [
            'qq'=>'QQ',
            'weibo'=>'Weibo',
